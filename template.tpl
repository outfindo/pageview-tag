...

{
  ...
  "description": "This template tracks pageviews on your website and sends the data to Outfindo statistics.",
  "containerContexts": [
    "WEB"
  ]
}
...
injectCustomScript(cookiesScript, data.gtmOnSuccess);

const gaId = toString(getCookie('_ga'));
const sessionId = toString(callInWindow('getSessionIdCookieValue'));
const visitorId = toString(callInWindow('getVisitorIdCookieValue'));
...
const jsonData = {
  ...
  region: 'cz',
  locale: 'cs_CZ',
  user_agent: callInWindow('getUserAgent'),
  payload: {},
};

const track = () => {
  callInWindow('trackEvent', jsonData);
  data.gtmOnSuccess();
};

injectCustomScript(trackingScript, track);
            ...
            "listItem": [
              ...
              },
              {
                ...
                "mapValue": [
                  {
                    "type": 1,
                    "string": "getVisitorIdCookieValue"
                  },
                  {
                    "type": 8,
                    "boolean": false
